...
CONTAINS
! ================================================================================= !
SUBROUTINE ROS(rp1,r,rm1,dr,dz,V_ij,V_ip1j,V_im1j,V_ijp1,V_ijm1,V_ip1jp1,V_ip1jm1,&
               V_im1jp1,V_im1jm1,SR_ij,SR_ip12j,SR_im12j,SR_ijp12,SR_ijm12)

DOUBLE PRECISION,INTENT(IN)  ::  rp1,r,rm1,dr,dz,V_ij,V_ip1j,V_im1j,V_ijp1,&
                                 V_ijm1,V_ip1jp1,V_ip1jm1,V_im1jp1,V_im1jm1
DOUBLE PRECISION,INTENT(OUT) ::  SR_ij,SR_ip12j,SR_im12j,&
                                 SR_ijp12,SR_ijm12
